...
<body>
    ...
    <?php
        $insert = $bdd->prepare('INSERT INTO equipe(Meneur, Arriere, Aillier, Aillier_Fort, Pivot) VALUES(:joueur, :joueur, :joueur, :joueur, :joueur)'); 
    ?>
